...
marker1.bindPopup(`
    <h3>Direction de l'Eau et de l'Assainissement de Seine-Saint-Denis (04/2024-09/2024)</h3>
    ...
    <p><strong>Lieu de travail:</strong>&nbsp;Rosny-sous-Bois,Seine-Saint-Denis(93)</p>
`);
           
var marker2 = L.marker([2.15, 15.80]).addTo(mapMini);
marker2.bindPopup(`
     <h3>Fondation pour le Tri-National de la Sangha (02/2025-04/2026)</h3>
     ...
     <p><strong>Lieux de travail:</strong>&nbsp;Yaoundé, Mfoundi, Cameroun; Paris, Paris, France</p>
`);
